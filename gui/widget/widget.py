...
class Widget(QWidget):
    ...
    def __init__(self, parent: QWidget = None) -> None:
        ...
        meta_gpt_3_5 = common.build_meta(model_name="gpt-3.5-turbo", callback=self.__conversation_thread)
        self.__conversation_thread.set_meta_gpt_3_5(meta_gpt_3_5)
        meta_gpt_4o = common.build_meta(model_name="gpt-4o", callback=self.__conversation_thread)
